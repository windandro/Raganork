/* Codded by @phaticusthiccy @afnanplk
...
if (Config.WORKTYPE == 'private') {
    ...
    Asena.addCommand({pattern: 'randomanime', fromMe: true, desc: Lang.RANDOMANIME_DESC}, (async (message, match) => {
    ...
    Asena.addCommand({ pattern: 'animesay ?(.*)', fromMe: false, desc: Lang.ANIME_DESC }, (async (message, match) => {
        ...
        Asena.addCommand({pattern: 'randomanime', fromMe: false, desc: Lang.RANDOMANIME_DESC}, (async (message, match) => {
